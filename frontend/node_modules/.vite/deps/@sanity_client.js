import {
  stegaClean
} from "./chunk-WAHYZ3S2.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
  __publicField
} from "./chunk-IOTDOPEA.js";
...
var h = (e2, t2) => {
  ...
  let a4 = new c2();
  a4 instanceof u && "object" == typeof o3.fetch && a4.setInit(o3.fetch, (_a2 = o3.useAbortSignal) != null ? _a2 : true);
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-EO54PKI3.js").then(function(n4) {
...
function _requestObservable(client, httpRequest, options) {
  ...
  let useCdn = ((_a2 = options.useCdn) != null ? _a2 : config2.useCdn) && canUseCdn;
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource2 } = await import("./browser-TW2Z2Y3Q.js");
      if (unsubscribed)
        return;
...
var LiveClient = class {
  ...
  events({
    ...
    return includeDrafts && token && (esOptions.headers = {
      ...
      async function getEventSource() {
        const EventSourceImplementation = typeof EventSource > "u" || esOptions.headers || esOptions.withCredentials ? (await import("./browser-TW2Z2Y3Q.js")).default : EventSource;
        if (unsubscribed)
          return;
        try {
          if (await fetch(url, {
...
// dep:@sanity_client
var sanity_client_default = deprecatedCreateClient;
export {
  BasePatch,
  BaseTransaction,
  ClientError,
